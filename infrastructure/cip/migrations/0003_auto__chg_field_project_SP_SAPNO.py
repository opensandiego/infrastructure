...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.SP_SAPNO'
        db.alter_column(u'cip_project', 'SP_SAPNO', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Project.SP_SAPNO'
        db.alter_column(u'cip_project', 'SP_SAPNO', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
    ...
    models = {
        ...
        u'cip.project': {
            ...
            'SP_SAPNO': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
