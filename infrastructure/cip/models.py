...
class Project(models.Model):
    ...
    SP_ASSET_TYPE_GROUP = models.CharField(max_length=50, null=True, blank=True)
    SP_ASSET_TYPE_CD = models.CharField(max_length=2, null=True, blank=True)
    SP_ASSET_TYPE_DESC = models.CharField(max_length=50, null=True, blank=True)
    ...
    SP_DELIVERY_METHOD_CD = models.CharField(max_length=3, null=True, blank=True)
    SP_DELIVERY_METHOD_DESC = models.CharField(max_length=50, null=True, blank=True)
    SP_FIELD_SENIOR_NM = models.CharField(max_length=50, null=True, blank=True)
    SP_PROJECT_PHASE = models.CharField(max_length=50, null=True, blank=True)
    ...
    SP_CLIENT1 = models.CharField(max_length=50, null=True, blank=True)
    SP_CLIENT2 = models.CharField(max_length=50, null=True, blank=True)
    ...
    SP_CONTRACT_CODE = models.CharField(max_length=50, null=True, blank=True)
    ...
    SP_ADDL_FUND_SOURCE2_DESC = models.CharField(max_length=50, null=True, blank=True)
    SP_ADDL_FUND_SOURCE3_CD = models.CharField(max_length=8, null=True, blank=True)
    SP_ADDL_FUND_SOURCE3_DESC = models.CharField(max_length=50, null=True, blank=True)
    ...
    SP_FUNDING_SOURCE_DESC = models.CharField(max_length=50, null=True, blank=True)
    SP_PROJECT_INFO_DESC = models.CharField(max_length=50, null=True, blank=True)
    SP_PROJECT_INFO2_DESC = models.CharField(max_length=50, null=True, blank=True)
    SP_PROJECT_KIND_DESC = models.CharField(max_length=50, null=True, blank=True)
    SP_PROJECT_KIND2_DESC = models.CharField(max_length=50, null=True, blank=True)
...
class DepartmentNeed(models.Model):
    ...
    system_rank = models.CharField(max_length=3, null=True, blank=True)
    distress = models.CharField(max_length=24, null=True, blank=True)
    correction = models.CharField(max_length=100, null=True, blank=True)
    code = models.CharField(max_length=8, null=True, blank=True)
    category = models.CharField(max_length=24, null=True, blank=True)
    maintenance = models.CharField(max_length=50, null=True, blank=True)
    ...
    recommendation = models.CharField(max_length=12, null=True, blank=True)
    size = models.PositiveIntegerField(null=True, blank=True)
    material = models.CharField(max_length=8, null=True, blank=True)
